    ...
    <body>
        <div class="dashboard-main-wrapper">
            <div class="navbar navbar-expand-lg navbar-expand-md navbar-expand-sm bg-white fixed-top" id="navbar-custom">
                <div class="container">
                    <a href="<?= base_url('staff/'); ?>"><img src="<?= base_url('images/'); ?>logorevota.jpg" id="navbar-brand"></a>
                    <a href="<?= base_url('staff/'); ?>" class="navbar-brand" id="text-brand">Revota Support System</a>
