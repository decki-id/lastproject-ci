<header class="dashboard-header">
  <section class="navbar navbar-expand-lg navbar-expand-md navbar-expand-sm bg-white fixed-top">
    <div class="navbar-nav ml-auto navbar-right-top">
      <?php if ($this->uri->total_segments() === 1 && $this->uri->segment(1) === 'agent') : ?>
      ...
      <?php elseif ($this->uri->segment(2) === 'ticket_details') : ?>
          ...
          <div class="nav-item">
            <div class="top-search-bar">
              <a href="<?= base_url('agent/print_ticket/'); ?><?= $ticket['id']; ?>/" class="button btn-back-custom form-control"
                target="_blank">Print
              </a>
            </div>
          </div>
          <div class="nav-item">
            <div class="top-search-bar">
              <a href="<?= base_url('agent/ticket_update_form/'); ?><?= $ticket['id']; ?>/" class="button btn-update-custom form-control">
                Update
              </a>
            </div>
          </div>
          <div class="nav-item">
            <div class="top-search-bar">
              <a href="<?= base_url('agent/delete_ticket/'); ?><?= $ticket['id']; ?>/" class="button btn-delete-custom form-control"
      ...
      <?php elseif ($this->uri->segment(2) === 'contacts') : ?>
        ...
        <div class="nav-item">
          <div class="top-search-bar">
            <a href="<?= base_url('agent/contact_form/'); ?>" class="button btn-add-custom form-control">Add New Contact</a>
          </div>
        </div>
      <?php elseif ($this->uri->segment(2) === 'contact_details') : ?>
          ...
          <div class="nav-item">
            <div class="top-search-bar">
              <a href="<?= base_url('agent/contact_update_form/'); ?><?= $contact['id']; ?>/" class="button btn-update-custom form-control">
                Update
              </a>
            </div>
          </div>
          <div class="nav-item">
            <div class="top-search-bar">
              <a href="<?= base_url('agent/change_contact_password/'); ?><?= $contact['id']; ?>/" class="button btn-change-custom form-control">
                Change Password
              </a>
            </div>
          </div>
      ...
      <?php elseif ($this->uri->segment(2) === 'companies') : ?>
        ...
        <div class="nav-item">
          <div class="top-search-bar">
            <a href="<?= base_url('agent/company_form/'); ?>" class="button btn-add-custom form-control">Add New Company</a>
          </div>
        </div>
      <?php elseif ($this->uri->segment(2) === 'company_details') : ?>
        ...
        <div class="nav-item">
          <div class="top-search-bar">
            <a href="<?= base_url('agent/company_update_form/'); ?><?= $company['id']; ?>/" class="button btn-update-custom form-control">
              Update
            </a>
          </div>
        </div>
      <?php elseif ($this->uri->segment(2) === 'company_contacts') : ?>
        ...
        <div class="nav-item">
          <div class="top-search-bar">
            <a href="<?= base_url('agent/print_contacts/'); ?><?= str_replace('%20', ' ', $this->uri->segment(3)); ?>/"
              class="button btn-update-custom form-control" target="_blank">Print
            </a>
          </div>
        </div>
      ...
      <?php elseif ($this->uri->segment(2) === 'agent_details') : ?>
        ...
        <div class="nav-item">
          <div class="top-search-bar">
            <a href="<?= base_url('agent/agent_update_form/'); ?><?= $agent['id']; ?>/" class="button btn-update-custom form-control">
              Update
            </a>
          </div>
        </div>
        <div class="nav-item">
          <div class="top-search-bar">
            <a href="<?= base_url('agent/change_agent_password/'); ?><?= $agent['id']; ?>/" class="button btn-change-custom form-control">
              Change Password
            </a>
          </div>
        </div>
      ...
      <?php elseif ($this->uri->segment(2) === 'report_mostcasesbysubject') : ?>
        ...
        <?php if ($this->input->post('from')) : ?>
          <div class="nav-item">
            <div class="top-search-bar">
              <a href="<?= base_url('/agent/print_report1'); ?>?from=<?= $this->input->post('from'); ?>&until=<?= $this->input->post('until'); ?>"
                class="button btn-print-custom form-control" target="_blank">Print
              </a>
            </div>
          </div>
        <?php else : ?>
