<div class="dashboard-wrapper">
    <div class="card">
        <div class="card-body">
            <form method="post" action="<?= base_url('agent/changeAgentPassword/'); ?>">
                <input type="hidden" class="form-control" id="id" name="id" value="<?= $agent['id']; ?>" />
                <div class="form-group row mb-3">
                    <label for="name" class="col-sm-2 col-form-label">Agent Name</label>
                    <div class="col-sm-10 pass-agent-custom">
                        <input type="text" class="form-control" id="name" name="name" value="<?= $agent['name']; ?>" disabled />
                    </div>
                </div>
                ...
                <div class="form-group row float-right">
                    <a href="<?= base_url('agent/agent_details/'); ?><?= $agent['id']; ?>/" class="btn btn-secondary">Cancel</a>
