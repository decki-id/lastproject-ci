...
<div class="ticket-box">
    <?php if (!$tickets) : ?>
        <div class="dashboard-wrapper text-center">
            ...
            <a href="<?= base_url('staff/ticket_form/'); ?>">Create new ticket</a>
        </div>
    <?php endif; ?>
                ...
                <div class="card-body w-55">
                    <div class="row no-gutters align-items-center">
                        <table class="no-border">
                            <tr>
                                <th rowspan="3">
                                    <a href="<?= base_url('staff/ticket_details/'); ?><?= $t['id']; ?>/">
                                        <img src="<?= base_url('images/'); ?><?= $t['contact_image']; ?>" class="user-avatar-md mr-3">
                                    </a>
                                </th>
                                <td><b><a href="<?= base_url('staff/ticket_details/'); ?><?= $t['id']; ?>/" id="ticket-link"><?= $t['subject']; ?></a></b> #<?= $t['id']; ?></td>
                            <tr>
