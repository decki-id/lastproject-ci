...
(26, '2020-02-03 08:20:48', '2020-02-04 15:43:23', 'Suryatama', 'Suryatama', 'Arena Experience', 'd.herdiawan.s@gmail.com', 'default_user2.png', 'Remote', 'Shop', 'Konfigurasi Dropbox', '<p>Selamat pagi Decki ID.</p><p>Dropbox di komputer server toko Trunojoyo tidak aktif, mohon dicek.</p><p>Terima kasih.</p>', 'Medium', '---', NULL, NULL, 'Open', NULL),
(27, '2020-02-03 08:23:10', '2020-02-04 15:43:23', 'Suryatama', 'Suryatama', 'Arena Experience', 'd.herdiawan.s@gmail.com', 'default_user2.png', 'Remote', 'Online', 'Konfigurasi Raven', '<p>Selamat pagi Decki ID.</p><p>Pengiriman report Raven tidak sampai ke email, mohon dicek.</p><p>Terima kasih.</p>', 'Medium', '---', NULL, NULL, 'Open', NULL),
(28, '2020-02-03 11:01:09', '2020-02-04 15:43:23', 'Suryatama', 'Suryatama', 'Arena Experience', 'd.herdiawan.s@gmail.com', 'default_user2.png', 'On The Spot', 'Expo', 'Instalasi', '<p>Halo.</p><p>Mohon bantuannya untuk install ulang sistem Decki ID.</p><p>Terima kasih.</p>', 'Medium', '---', NULL, NULL, 'Open', NULL),
(29, '2020-02-04 11:12:28', '2020-02-04 15:43:23', 'Fafa', 'Fafa', 'Realizm87', 'd.herdiawan.s@gmail.com', 'default_user2.png', 'Remote', 'Expo', 'Instalasi', '<p>Selamat siang.</p><p>Tolong bantu install ulang sistem Decki ID.</p><p>Terima kasih.</p>', '---', '---', NULL, NULL, 'Open', NULL),
